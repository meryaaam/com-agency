...
const services = [
  {
    ...
    description:
      "Tailored strategies that boost your brand's visibility and connect with your audience like never before.",
  ...
  },
  {
    ...
    description:
      "Designs that don’t just catch the eye, but captivate the mind and inspire action.",
  ...
  },
  {
    ...
    description:
      "Be found, be chosen—SEO that puts your brand on the digital map and keeps it there.",
  ...
  },
  {
    ...
    description:
      "Innovative digital experiences, seamless performance, and platforms that keep your users coming back for more.",
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      services.forEach((item, index) => {
        ...
        newVisibleCards[index] =
          scrollY > triggerPoint && scrollY < triggerPoint + 300;
                            ...
                            <div className="relative col-span-6 md:col-span-4">
                              <div
                                className={subtitle({
                                  color: "blue",
                                  class:
                                    "w-full text-lg font-bold lg:text-xl max-w-xl mt-4 mx-auto",
                                })}
                              >
