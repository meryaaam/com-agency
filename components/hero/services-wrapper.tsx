...
export const ServicesWrapper :React.FC<CradProps> = ({i,title, description, src, link, color, range, targetScale, progress}) => {
  ...
  return (
    <div ref={container} className='cardContainer h-screen flex items-center justify-center sticky top-0'>
      <motion.div className='card flex flex-col relative h-[500px] w-[1000px] rounded-3xl p-12' 
