  ...
  return (
    ...
    style={{    position: "relative",
      ...
      <div style={{ position: "absolute", top: "calc(100vh - 350px)"}}>
        <div ref={slider} style={{whiteSpace: "nowrap" , position: "relative"}}>
          <p ref={firstText} 
             style={{position: 'relative', margin: 0,  color: 'black', fontSize: '230px',
                   fontWeight: 500,paddingRight: '50px' }}>
                    Freelance Developer -
            </p>
          <p ref={secondText} style={{
                position: 'absolute',
                left: '100%',
                top: 0,
                margin: 0,
