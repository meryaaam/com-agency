...
const eventHighlight = [
  {
    ...
    description:
      " A main stage presentation where key team members share stories of impactful projects, demonstrating the results and innovative approaches your agency brings to the table.",
  },
  {
  ...
  },
  {
    ...
    description:
      "End the night with a networking session where guests can connect with your team in an informal setting, ask questions, and discuss potential collaborations.",
  },
  {
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="text-left p-6 mt-4">
              ...
              <p className="text-white/70 text-lg">
                A Night of Innovation and Insight.
              </p>
              <div className="text-left text-white p-6 mt-4">
                ...
                zones, attendees gain a firsthand look at your capabilities and
                approach.
              </div>
