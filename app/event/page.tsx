  ...
  return (
    <div className="py-[72px] sm:py-24 "> 
      <div className="">
        ...
        <span className={title({size:"lg" , color:"violet"})}> Telescope&nbsp;</span>
        </div>
        <div className='max-w-xl mx-auto'>
        <div className={subtitle({ class: "text-center mt-5w-full text-lg lg:text-xl text-default-600 max-w-xl mt-4 mx-auto" })}>
